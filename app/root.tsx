...
import remixStyles from "~/styles/remix/remix.css";
import globalStylesUrl from "~/styles/global.css";
import playerStylesUrl from "~/styles/remix/player.css";
      ...
      <header className="remix-app__header">
        <div className="container remix-app__header-content">
          <Link to="/" title="Remix" className="remix-app__header-home-link">
              <RemixLogo className="remix-app_header-left-logo" />
              X
              <XStateLogo className="remix-app_header-right-logo" />
          </Link>
          <nav aria-label="Main navigation" className="remix-app__header-nav">
            <ul>
              ...
              <li>
                <a href="https://github.com/EtienneFR/audio-player-remix-app" target="_blank">Source Code on GitHub</a>
              </li>
            </ul>
          </nav>
        </div>
...
function RemixLogo(
  style: React.ComponentPropsWithoutRef<"div">,
...
function XStateLogo(
  ...
  return (
    <div {...style}>
      ...
      {...props}
      >
        <title id="remix-run-logo-title">XState Logo</title>
        ...
        <path d="M180.9,60.5h-15.1l-3.1,9.2h-6.4l14.4-41h5l14.4,41H184L180.9,60.5z M179.2,55l-5.7-17.9h-0.1L167.6,55H179.2z" />
