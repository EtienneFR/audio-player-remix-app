        ...
        <div className="container remix-app__header-content">
          ...
          <nav aria-label="Main navigation" className="remix-app__header-nav">
            <ul>
              ...
              <li>
                <a href="https://github.com/EtienneFR/audio-player-remix-app">Source Code on GitHub</a>
              </li>
            </ul>
          </nav>
        </div>
...
function XStateLogo(props: React.ComponentPropsWithoutRef<"svg">) {
  return (
    <svg
